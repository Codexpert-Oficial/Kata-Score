...
<body>
    ...
    <main>
        ...
        <article class="controlPanel">
            ...
            <section class="controlPanel__container">
                ...
                <a href="../../model/callCurrentParticipant.php" class="button callCurrentParticipant">Llamar a participante
                    actual</a>
                <a href="../../model/scoreCurrentParticipant.php" class="button scoreCurrentParticipant">Mostrar puntaje de
    ...
    <script src="../../controller/scoreScreen.js"></script>
